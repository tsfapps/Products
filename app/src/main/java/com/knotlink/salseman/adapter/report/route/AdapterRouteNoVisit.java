...
public class AdapterRouteNoVisit extends RecyclerView.Adapter<AdapterRouteNoVisit.RouteNoActivityViewHolder> {

    private Context tContext;
    private List<ModelRouteNoVisit> tModels;

    public AdapterRouteNoVisit(Context tContext, List<ModelRouteNoVisit> tModels) {
    ...
    public void onBindViewHolder(@NonNull final RouteNoActivityViewHolder routeNoActivityViewHolder, int i) {
        ...
        ModelRouteNoVisit tModel = tModels.get(i);
        routeNoActivityViewHolder.tvRouteComplainShopName.setText(tModel.getShopName());
        routeNoActivityViewHolder.tvRouteComplainDateOfOrder.setText(tModel.getDate());
        ...
        final String strAreaStatus = tModel.getVisitStatus();
