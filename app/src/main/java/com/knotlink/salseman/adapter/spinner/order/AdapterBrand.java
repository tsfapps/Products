...
public class AdapterBrand extends BaseAdapter {
    ...
    private List<ModelBrand> tModels;

    public AdapterBrand(Context tContext, List<ModelBrand> tModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tListContent.text.setText(tModels.get(position).getBrandName());
        return view;
    }
}
