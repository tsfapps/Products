...
public class AdapterCategory extends BaseAdapter {
    ...
    private List<ModelCategoryArticle> tModels;

    public AdapterCategory(Context tContext, List<ModelCategoryArticle> tModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tListContent.text.setText(tModels.get(position).getCategory());
        return view;
    }
}
