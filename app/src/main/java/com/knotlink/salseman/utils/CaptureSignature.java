...
public class CaptureSignature extends View {
   ...
   // LinearLayout llSignPlace;
    com.knotlink.salseman.activity.CaptureSignature.signature mSignature;
    ...
    View mView;
    File mypath;
        public CaptureSignature(Context context, AttributeSet attrs)
        {
            super(context, attrs);
