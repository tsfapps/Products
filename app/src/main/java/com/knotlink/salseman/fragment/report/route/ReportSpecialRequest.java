...
public class ReportSpecialRequest extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ReportSpecialRequest newInstance(String dateFrom, String dateTo) {

        ReportSpecialRequest fragment = new ReportSpecialRequest();
